...
if($nbrresult>=1)
	...
	//summary table
	$nbrtotcrawler=sizeof($listcrawler);
	...
	echo"<td class='tableau5'>".$nbrtotcrawler."</td></tr>\n";	
	echo"</table></div><br>\n";	
	...
	foreach ($table as $page1)
		...
		if ($comptligne%2 ==0)
			{
			echo"<tr><td class='tableau3'><a href='index.php?navig=2&amp;period=".$period."&amp;site=".$site."&amp;crawler=".$page1."'>".$page1display."</a></td>\n";
			...
			{
			echo"<tr><td class='tableau30'><a href='index.php?navig=2&amp;period=".$period."&amp;site=".$site."&amp;crawler=".$page1."'>".$page1display."</a></td>\n";
